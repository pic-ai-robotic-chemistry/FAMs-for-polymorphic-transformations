...
- **MACE** support is built on the *e3nn* ecosystem and the MACE framework.  <img src="images/MACE.png" alt="MACE" width="72" />
- **SevenNet** support is built on the *e3nn* ecosystem and the SevenNet framework. <img src="images/SeveNet.png" alt="SevenNet" width="72" /> 
- **CHGNet** support uses PEFT-style adapters and CHGNet framework. <img src="images/CHGNet.png" alt="CHGNet" width="72" />
